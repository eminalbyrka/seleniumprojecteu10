...
//3. Locate all the WebElements on the page using XPATH and/or CSS
        ...
        //webelement string gibi bir object.
...
//b. “Forgot password” header
        ...
        WebElement header_ex1 = driver.findElement(By.cssSelector("div.example > h2"));//bu şekilde
        //yapıyoruz. önce cssselector ile clastan bulduk ve h2.ye geç dedik.

//Locate header using xpath, and using web elements text "Forgot Password"
        WebElement header_ex2 = driver.findElement(By.xpath("//h2[text()='Forgot Password']"));//attribute yok
        //yinede text() kullanarak yapabiliyoruz.
        WebElement header_ex3 = driver.findElement(By.xpath("//h2[.='Forgot Password']"));//burada nokta işareti text(). demek.
