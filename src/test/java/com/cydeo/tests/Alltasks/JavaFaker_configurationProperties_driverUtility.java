...
public class JavaFaker_configurationProperties_driverUtility {
    @Test
    public void registration_form_test() {
        //1. Open browser
        //2. Go to website:https://practice.cydeo.com/registration_form
        //Driver.getDriver() --> driver
        Driver.getDriver().get(ConfigurationReader.getProperty("registration.form.url"));//get parantezin
        // içinde configurationReader clasından getProperty methodunu çağırıyorum.
        // getProperty bize key yoluyla value veriyor.
        ...
        WebElement checkbox1 = Driver.getDriver().findElement(By.xpath("//input[@value='javascript']"));
        checkbox1.click();
